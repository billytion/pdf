...
from PDFCore import PDFParser, vulnsDict, PDFIndirectObject, PDFBody, PDFObject 
...
def getPeepXML(statsDict, version, revision):
    ...
    for version in range(len(statsDict['Versions'])):
        ...
        for id in statsVersion['Objects'][1]:
            ...
            if objects.pdfObject.hasElement('/Type'):
                typeObject = objects.pdfObject.getElementByName('/Type')
